...
#define WHATSAPP_STATUS_OFFLINE	0
#define WHATSAPP_STATUS_ONLINE	3
#define WHATSAPP_STATUS_INLOBBY	4
#define WHATSAPP_STATUS_INGAME	5
...
const char *whatsapp_normalize_nick(const PurpleAccount *acct, const char *input);
